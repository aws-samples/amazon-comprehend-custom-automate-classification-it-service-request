...
class ExtractLoadTransformEndPointCreateStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, bucket_name: str, vpc: _ec2.Vpc , efs_ap_id: str, file_system_id: str,  comprehendcustomnotificationtopic: _sns.Topic ,  **kwargs) -> None:
        ...
        comprehend_role = _iam.Role(self, "ComprehendCustomRole",
        ...
        etl_lambda.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
            "AmazonS3FullAccess"))
        etl_lambda.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
        ...
        # Create Train Classifier Lambda
        train_classifer_lambda = _lambda.Function(self, "TrainClassifierLambda",
                                                  ...
                                                  environment={
                                                     ...
                                                     "TOPIC_ARN": comprehendcustomnotificationtopic.topic_arn,
                                                     "COMPREHEND_DATA_ACCESS_ROLE_ARN": comprehend_role.role_arn})
        train_classifer_lambda.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
            "AmazonS3FullAccess"))
        train_classifer_lambda.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
        ...
        pass_role_policy = _iam.Policy(self, "PassroleToComprehend", statements=[_iam.PolicyStatement(
            actions=["iam:PassRole"], resources=[comprehend_role.role_arn])])
        ...
        #Parse Comprehend Document Classifier Model
        extract_comprehend_model_name  = _lambda.Function(self, "ExtractComprehendCustomModelARNLambda",
        ...
        extract_comprehend_model_name.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
            "AmazonS3FullAccess"))
        extract_comprehend_model_name.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
            "ComprehendFullAccess"))
        extract_comprehend_model_name.role.add_managed_policy(_iam.ManagedPolicy.from_aws_managed_policy_name(
        ...
        create_s3_notification = _aws_s3_notifications.LambdaDestination(extract_comprehend_model_name)
